    ...
    <div class="container">
        <div class="inner-wrap">
            <div class="company-header">
                <h2 class="company-heading">Top <span>4 companies</span></h2>
    ...
    <div class="container">
        <div class="inner-wrap">
            <div class="build-profile-left">
                ...
                <button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" class="button-create">Create
                    Resume</button>
                <!-- Modal -->
                            ...
                            <div class="modal-body">
                                <form action="./resume/upload.php" method="post">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button value="Upload Image" name="submit" type="submit"
                                            class="btn btn-primary">Upload Resume</button>
                                    </div>
